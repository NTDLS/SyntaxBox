	...
	public class AutoListForm : Form
	{
        ...
        private TipForm tipForm
        {
            get
            {
                if (_TipForm == null)
                {
                    this._TipForm = new TipForm();
                    this._TipForm.Owner = this;

                    NativeUser32Api.SetWindowLong(this._TipForm.Handle,
                                                NativeUser32Api.GWL_STYLE,
                                                (int)NativeUser32Api.WS_CHILD);

                    this._TipForm.Visible = false;
                }
		...
		private void InitializeComponent()
		{
			...
			this.LB = new NTDLS.Windows.Forms.CodeEditor.TabListBox();
            ...
            this.Move += new EventHandler(AutoListForm_Move);
        ...
        void AutoListForm_Move(object sender, EventArgs e)
        {
            this.tipForm.Top = this.Top + Height - this.tipForm.Height;
            this.tipForm.Left = this.Left + this.Width;
        }
        ...
        private void LB_SelectedIndexChanged(object sender, EventArgs e)
		{
            ...
            if (li.ToolTip != null && li.ToolTip != "")
			{
                this.tipForm.TipText = li.ToolTip;

                if (this.tipForm.Visible == false)
                {
                    this.tipForm.TopLevel = true;
                    this.tipForm.BringToFront();
                    this.tipForm.Top = this.Top + Height - this.tipForm.Height;
                    this.tipForm.Left = this.Left + this.Width;
                    this.tipForm.Visible = true;
                }
			}
            else
            {
