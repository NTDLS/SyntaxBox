...
using NTDLS.Drawing.GDI;
using NTDLS.Syntax;
using NTDLS.Windows.Forms;
using NTDLS.Windows.Forms.CodeEditor;
using NTDLS.Windows.Forms.CodeEditor.TextDraw;
using NTDLS.Timers;
using NTDLS.Win32; 
...
namespace NTDLS.Windows.Forms
{
	...
	public class CodeEditorControl : Widget
	{
        ...
        /// <summary>
        /// Fired when the Find or Replace text is not found.
        /// </summary>
        public event FindReplaceTextNotFoundHandler FindReplaceTextNotFound = null;
        ...
        public ListBox.ObjectCollection AutoListItems
        {
            get { return _ActiveView.AutoListItems; }
        }
     ...
     //   [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
		...
		{
			_ActiveView.Copy();
            //this.Saved = false; //JMP 5/19/2010 - This doesnt change anything.
		}
        ...
        {
            return _ActiveView.FindReplaceDialog.LastSearchString;
        }
        ...
        /// </code>
        /// </example>
        public void ShowFind(string defaultText)
        {
            _ActiveView.ShowFind(defaultText);
        }
        ...
        /// </code>
        /// </example>
        public void ShowReplace(string defaultText)
        {
            _ActiveView.ShowReplace(defaultText);
        }
...
//			this.splitView1.Visible = false;
			...
			KeyboardActions.Add(new KeyboardAction(Keys.Z, true, true, false, false, new ActionDelegate(this.Redo)));
...
//			this.splitView1.Visible = true;
		...
		{
			OnKeyUp(e);
            //this.Saved = false; //%%___|JMP(5/19/2010) - This doesnt *necessarily* change anything. Needs to be moved to text changed event.
		}
		...
		private void InitializeComponent()
		{
            ...
            this.ParseTimer = new NTDLS.Timers.WeakTimer(this.components);
            this.SuspendLayout();
            // 
            // _GutterIcons
            // 
            ...
            this._AutoListIcons.Images.SetKeyName(9, "");
            this._AutoListIcons.Images.SetKeyName(10, "");
            this._AutoListIcons.Images.SetKeyName(11, "");
            // 
            // ParseTimer
            // 
		...
		private void CreateViews()
		{
			...
			foreach (EditViewControl ev in Views)
			{
                ...
                ev.FindReplaceDialog.TextNotFound += new FindReplaceTextNotFoundHandler(FindReplaceDialog_TextNotFound);
        ...
        void FindReplaceDialog_TextNotFound(object sender, string text)
        {
            if (FindReplaceTextNotFound != null)
            {
                FindReplaceTextNotFound(this, text);
            }
        }
		...
		protected virtual void OnChange(object Sender, EventArgs e)
		{
            ...
            this.Saved = false; //%%___|JMP(5/19/2010) - The text changed.
		}
