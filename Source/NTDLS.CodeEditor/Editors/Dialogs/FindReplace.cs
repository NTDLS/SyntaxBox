...
//				}
        ...
        public void ShowFind(string defaultText)
        {
            ...
            _Last = "";
            if (defaultText.Length == 0 && cboFind.Items.Count > 0)
            {
                cboFind.SelectedIndex = 0;
            }
            else
            {
                cboFind.Text = defaultText;
            }
            cboFind.Focus();
        }
        ...
        public void OnTextNotFound(string text)
        {
		...
		public void FindNext()
		{
            ...
            if (!mOwner.SelectNext(cboFind.Text, chkMatchCase.Checked, chkWholeWord.Checked, chkRegEx.Checked))
            {
                OnTextNotFound(text);
            }
		}
