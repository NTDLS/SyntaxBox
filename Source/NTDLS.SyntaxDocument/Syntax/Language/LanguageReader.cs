...
namespace NTDLS.Syntax
{
    ...
    public class SyntaxLoader
    {
        ...
        private void ParseBlock(XmlNode parentNode, XmlNode node)
        {
            ...
            ParseBlockBody(parentNode, bl, node.ChildNodes);
        }
        ...
        private BlockType GetBlock(string Name)
        {
            ...
            {
                NTDLS.Syntax.BlockType b = new NTDLS.Syntax.BlockType(_Language);
                _Blocks.Add(Name, b);
            }
