...
using System.Text;
using NTDLS.Syntax.SyntaxDocumentParsers;

namespace NTDLS.Syntax
{
	/// <summary>
	/// 
	/// </summary>
	...
	public class SyntaxDocument : Component, IEnumerable
	{
		...
		/// <summary>
        /// Get or Set the Modified flag, fires OnModifiedChanged if value has changed.
		/// </summary>
...
//			}
        ...
        public Word GetValidWordFromPos(TextPoint p)
        {
            Row xtr = this[p.Y];
            int CharNo = 0;

            if (p.X == 0 && xtr.Count > 0)
            {
                return xtr[0];
            }
