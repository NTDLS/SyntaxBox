...
//    Copyright (C) 2005  Riccardo Marzi  <riccardo@dotnetNTDLS.net>
//
//    Copyright (C) 2005  Sebastian Faltoni <sebastian@dotnetNTDLS.net>
//
...
namespace NTDLS.Drawing.Shapes
{
	...
	public class ShapeRectangle : Shape,IDrawable,IFillable,IRectangle
	{
        ...
        {
            return "{NTDLS.Drawing.Shapes.ShapeRectangle}";
        }
