...
namespace NTDLS.Drawing.ImageInfo
{
	...
	public class PropertyTag
	{
		...
		private static sys.Text.ASCIIEncoding _encoding = new sys.Text.ASCIIEncoding();
				...
				switch ((PropertyTagType)aPropertyItem.Type) {
					...
					case PropertyTagType.Rational :
							...
							for (int i=0; i<_resultRational.Length; i++)
							{
								...
								if (_resultRational[i]==null) throw new Exception("Null");
							}
