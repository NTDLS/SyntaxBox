...
using NTDLS.IO.Compression.Checksums;
using NTDLS.IO.Compression.Zip.Compression.Streams;
using NTDLS.IO.Compression.Zip.Compression;
using NTDLS.IO.Compression.Encryption;

namespace NTDLS.IO.Compression.Zip 
{
	...
	public class ZipFile : IEnumerable
	{
		...
		/// An i/o error occurs.
		/// </exception>
		/// <exception cref="NTDLS.IO.Compression.Zip.ZipException">
